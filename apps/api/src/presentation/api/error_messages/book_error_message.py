...
# 一般的なエラーメッセージ
BOOK_NOT_FOUND = "指定されたIDの書籍が見つかりません。"
BOOK_ACCESS_DENIED = "この書籍へのアクセス権限がありません。"
BOOK_FILE_NOT_FOUND = "この書籍のファイルが見つかりません。"
BOOK_COVER_NOT_FOUND = "この書籍のカバー画像が見つかりません。"
...
BOOK_TITLE_TOO_LONG = "書籍のタイトルは100文字以下である必要があります。"
BOOK_DESCRIPTION_TOO_LONG = "書籍の説明は1000文字以下である必要があります。"
BOOK_DATA_REQUIRED = "書籍データは必須です。"
BOOK_USER_ID_REQUIRED = "ユーザーIDは必須です。"
BOOK_ID_INVALID_FORMAT = "書籍IDの形式が無効です。有効なUUIDを指定してください。"
