            ...
            {script.map((turn, index) => (
              ...
              >
                <div className="flex-shrink-0">
                  <span 
                    className={`${speakerColors[turn.speaker] || 'bg-primary'} text-primary-foreground inline-flex h-8 w-8 items-center justify-center rounded-full text-sm font-medium`}
                    aria-hidden="true"
                  >
                    {turn.speaker}
                  </span>
