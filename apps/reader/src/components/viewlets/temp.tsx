...
export default function Page() {
  ...
  return (
    <div className="flex h-full w-full flex-col">
      <div className="bg-muted/40 w-full flex-1 overflow-y-auto">
        <ChatMessageList>
          {/* Chat messages */}
          <AnimatePresence>
      ...
      <div className="bg-muted/40 px-4 pb-4">
        ...
        >
          <ChatInput
            ...
            className="min-h-12 bg-background resize-none rounded-lg border-0 p-3 shadow-none focus-visible:ring-0"
          />
